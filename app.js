...
function actualizarResumen() {
    ...
    document.getElementById("totalMandosActivos").textContent = mandosActivos;
    document.getElementById("totalMandosVacaciones").textContent = mandosVacaciones;
...
function buscar() {
    ...
    const resultado = personal.filter(persona => {
        ...
        const chapa = valor(persona, "CHAPA").toUpperCase();
        const nombre = valor(persona, "PERSONAL PMT").toUpperCase();
        const cargo = valor(persona, "CARGO").toUpperCase();
